...
@st.cache_data
def load_data():
    accept = pd.read_csv("streamlit/data/accepted.csv", low_memory=False)
    target = "loan_status"
...
<style>
    ...
    #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-uf99v8.ea3mdgi8 > div.block-container.st-emotion-cache-z5fcl4.ea3mdgi5 > div > div > div > div:nth-child(9) > div:nth-child(1) > div > div > div > div > div > button{
        width: 20em;
        height: 20em;
        margin-right: 10px;
    }
    #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-uf99v8.ea3mdgi8 > div.block-container.st-emotion-cache-z5fcl4.ea3mdgi5 > div > div > div > div:nth-child(9) > div:nth-child(1) > div > div > div > div > div > button > div > p{
        font-size: 1.4rem;
        font-weight: bold;
    }
    
    #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-uf99v8.ea3mdgi8 > div.block-container.st-emotion-cache-z5fcl4.ea3mdgi5 > div > div > div > div:nth-child(9) > div:nth-child(2) > div > div > div > div > div > button{
        width: 20em;
        height: 20em;
        margin-left: 10px;
    }
    #root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.st-emotion-cache-uf99v8.ea3mdgi8 > div.block-container.st-emotion-cache-z5fcl4.ea3mdgi5 > div > div > div > div:nth-child(9) > div:nth-child(2) > div > div > div > div > div > button > div > p{
        font-size: 1.4rem;
        font-weight: bold;
    }
